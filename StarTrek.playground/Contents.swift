...
var humanOfficerCount = humanOfficers.count
print(humanOfficerCount)



// Q1: What percentage of humans are female?

// # femaleOfficers / # humanOfficers
// # femaleOfficers / humanOfficers.count

var femHumOfficerCount = humanOfficers.filter{femaleOfficers.contains($0)}.count
print (Float(femHumOfficerCount) / Float(humanOfficerCount))



// Q2: How many first officers are human?
var firstHumOfficerCount = firstOfficers.filter{humanOfficers.contains($0.key)}.count
print (firstHumOfficerCount)
...
var vulcanFirstOfficers = firstOfficers.filter{ vulcanOfficers.contains($0.key)}.map{Officer(name: $0.key, ship: $0.value)}
print(vulcanFirstOfficers)


// Q7: How many these Vulcan first officers have names shorter than 5 characters?
var vulcanCnt = vulcanFirstOfficers.filter{$0.name.count < 5}.map{$0.name}
print(vulcanCnt)
